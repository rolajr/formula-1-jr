...
export const metadata = {
  title: 'ESPN 3 en Vivo - F1 App',
  description: 'Mira ESPN 3 en vivo',
};

export default function ESPN3Page() {
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-heading font-bold text-light-50">
              Transmisión en Vivo - ESPN 3
            </h1>
          </div>
          <p className="text-light-400">
            Disfruta de ESPN 3 en directo desde nuestra aplicación
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <LiveStreamWidget channel="espn3" />
          </div>
        </div>
      </div>
    </div>
